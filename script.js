...
// NEXT STEPS:
// Once generate password button is clicked, I need to display the password in the text area content box. 
...
function generatePassword() {
  ...
  var isValidLength = userLength < 8 || userLength > 128;

  // create conditions for user inputted characters.

  if (isValidLength) {
    generatePassword(); //starts the process over again
  } else {
    userPrompts(); //this is the main function that runs everything
  }

  // userPrompts main function below, along with conditionals for for loop_____________________________________________ //
